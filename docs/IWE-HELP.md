...
| Тип | Что | Примеры |
|-----|-----|---------|
| **Системы** | Программы, которые работают | Claude Code, Telegram-бот, MCP-серверы (knowledge-mcp, ddt), WakaTime, Git, Marp |
...
> Полный реестр ролей: `DP.AGENT.001` (через MCP: `knowledge-mcp search("реестр ролей агентов")`).
...
- `DP.IWE.001` — что такое IWE, зачем, 4 архитектурных вида, сравнения (vs экзокортекс, vs агенты, vs second brain)
